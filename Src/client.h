...
#include "live/liveMedia/include/RTSPClient.hh"		//      RTSP client class
#include "live/liveMedia/include/MediaSession.hh"
...
SwsContext 	*pSwsCtx;		//	New structure for last FFmpeg libraries (Dec-10-2010)
...
int Init_Session(char const *URL,int ID, int width, int heigh);//       Setup the connection
void close_Session();                   //      close the current connection 
