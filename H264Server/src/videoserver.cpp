...
// Setup server
void videoServer::setupServer(int rtspPort)
{
  try{
...
void videoServer::AddRTPSession(const char* name)
{
  try{
      int i = 0;
...
ServerMediaSession* videoServer::getRTPSession(int i)
{

}

// start the server
bool videoServer::play(void )
{

}

// stop the server
bool videoServer::stop(void )
{

}

#include "videoserver.moc"
